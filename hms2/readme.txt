...
### SOFTWARES USED
  - XAMPP was installed on the Ubuntu 19.04 machine and APACHE2 Server and MySQL were initialized. And, files were built inside opt/xampp/htdocs/myhmsp
...
'About Us' allows us to get some more information about the quality and the services of the hospital.
...
In this page, doctor can able to see their appointments which has been booked by the patients. There we can see the appointment of the doctor ‘xxxx’ which has been booked by the patient ‘yyyyy’. This means that the doctor ‘xxx’ will have an appointment with the patient ‘yyy’ on dd-mm-yyyy. 
...
### 1. Cancel Appointments
  ...
  If the patient deletes the last record (for doctor xxx), then a label "deleted by you" will be displayed in the column 'Current Status' and the action will change to cancel state.
  
  
  Now if we login to the doctor xxx's account and view his appointment details, then it will look like this:
