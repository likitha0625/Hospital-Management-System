...
<body style="padding-top:50px;">
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          ...
          <div class="row">
                  <div class="col-md-4 text-right" ><label>Disease:</label></div>
                  <div class="col-md-8">
                  <!-- <input type="text" class="form-control" name="disease" required> -->
                  <textarea id="disease" cols="86" rows ="2" name="disease" required></textarea>
                  </div><br><br><br>
                  
                  <div class="col-md-4 text-right"><label>Allergies:</label></div>
                  <div class="col-md-8">
                  <!-- <input type="text"  class="form-control" name="allergy" required> -->
                  <textarea id="allergy" cols="86" rows ="2" name="allergy" required></textarea>
                  </div><br><br><br>
                  <div class="col-md-4 text-right"><label>Prescription:</label></div>
                  <div class="col-md-8">
